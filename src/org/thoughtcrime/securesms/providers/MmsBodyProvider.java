...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://im.cable.provider.cableim.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("im.cable.provider.cableim.mms", "mms/#", SINGLE_ROW);
  }
